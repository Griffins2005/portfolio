...
export default function Home() {
  return (
    <div className="min-h-screen">
      {/* Hero Section - Creative Minimalist */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 md:py-32">
        <div className="grid md:grid-cols-[1.2fr_1fr] gap-10 md:gap-16 items-center">
          ...
          <div className="space-y-8 sm:space-y-10">
            <div className="space-y-4 sm:space-y-5">
              <div className="inline-flex items-center space-x-2">
                ...
                <span className="text-xs sm:text-sm text-gray-500">From Kenya to Cornell</span>
              </div>
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3 pt-3 sm:pt-4">
                <span className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-900 text-white text-xs sm:text-sm rounded-full">Data Science</span>
                <span className="px-3 sm:px-4 py-1.5 sm:py-2 border border-gray-300 text-gray-700 text-xs sm:text-sm rounded-full">Full-Stack</span>
                <span className="px-3 sm:px-4 py-1.5 sm:py-2 border border-gray-300 text-gray-700 text-xs sm:text-sm rounded-full">AI</span>
                <span className="px-3 sm:px-4 py-1.5 sm:py-2 border border-gray-300 text-gray-700 text-xs sm:text-sm rounded-full">Blockchain</span>
              </div>
            ...
            <div className="space-y-2 pt-2">
              <p className="text-xs font-medium text-gray-500 tracking-wide uppercase">Get in Touch</p>
          ...
          {/* Right: Headshot with creative layout */}
          <div className="relative flex justify-center md:justify-end mt-10 md:mt-0">
            <div className="relative">
              {/* Decorative elements */}
              <div className="absolute -top-4 -right-4 w-48 sm:w-64 md:w-72 h-48 sm:h-64 md:h-72 bg-yellow-50 rounded-full blur-3xl opacity-50"></div>
              <div className="absolute -bottom-4 -left-4 w-40 sm:w-56 md:w-64 h-40 sm:h-56 md:h-64 bg-orange-50 rounded-full blur-3xl opacity-50"></div>
      ...
      {/* About Section - Creative Grid */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="grid md:grid-cols-[1fr_1.5fr] gap-8 sm:gap-12">
          {/* Left: About Text */}
          <div className="space-y-4 sm:space-y-5">
            <div className="inline-block">
              <h2 className="text-3xl sm:text-4xl font-semibold text-gray-900 mb-2">About</h2>
              <div className="h-1 w-16 sm:w-20 bg-gray-900 rounded-full"></div>
            </div>
          ...
          <div className="grid gap-4 sm:gap-6 mt-8 md:mt-0">
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="p-6 sm:p-8 border-2 border-gray-200 rounded-2xl hover:border-gray-900 transition-colors">
                <div className="mb-3 sm:mb-4">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Data Science & ML</h3>
                </div>
                <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                  Developing predictive models and analyzing data to drive insights with Python and scikit-learn.
                </p>
              </div>
              
              <div className="p-6 sm:p-8 border-2 border-gray-200 rounded-2xl hover:border-gray-900 transition-colors">
                <div className="mb-3 sm:mb-4">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Blockchain</h3>
                </div>
                <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                  Exploring decentralized applications and smart contracts with Solidity and Web3.
                </p>
              </div>
            </div>
          </div>
